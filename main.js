...
//this is a really dumb example, reduce does not really work here
...
//Again, reduce doesn't really work in this situation...
var housereduce = house.inside.reduce(function(a, b) {
	return (a + b) + " This won't make any sense! ";
});
...
avgPrice.price = (avgPrice.price/items.length).toFixed(2);
console.log("The average price is " + avgPrice.price);
